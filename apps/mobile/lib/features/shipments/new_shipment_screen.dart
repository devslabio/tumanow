      ...
      body: ListView(
        ...
        children: [
          ...
          ExpansionTile(
            ...
            subtitle: const Text('Optional pickup and delivery contacts'),
            children: [
              TextField(
              ...
              TextField(
                ...
                decoration: const InputDecoration(labelText: 'Pickup contact phone'),
              ),
              const SizedBox(height: 16),
              TextField(
                controller: _deliveryContactName,
                textCapitalization: TextCapitalization.words,
                decoration: const InputDecoration(labelText: 'Delivery contact name'),
              ),
              const SizedBox(height: 10),
              TextField(
                controller: _deliveryContactPhone,
                keyboardType: TextInputType.phone,
                decoration: const InputDecoration(labelText: 'Delivery contact phone'),
              ),
            ],
          ),
          const SizedBox(height: 16),
